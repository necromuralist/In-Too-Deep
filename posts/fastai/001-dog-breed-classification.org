...
#+OPTIONS: H:5
#+TOC: headlines 2
#+PROPERTY: header-args :session /home/athena/.local/share/jupyter/runtime/kernel-1adfbb92-a038-48bf-a0c7-ae9ad6f5462e.json
...
Bu, see the next section for why I don't use it.
...
CPU:   2,373  55,189  64,239 MB   3.69% 
...
#+RESULTS:
: ･ RAM:  △Consumed    △Peaked    Used Total | Exec time 0:00:00.454
: ･ CPU:          0          0      2,499 MB |
: ･ GPU:         44         42      1,437 MB |
...
#+begin_src python :results raw drawer :ipyfile ../../files/posts/fastai/dog-and-cat-breed-classification/top_losses.png
